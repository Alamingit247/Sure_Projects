        ...
        <div class="content-wrapper">
          <div class="row mb-3">
            ...
            <div class="col-md-10 m-auto  grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h3 class="card-title text-center">Recruitment</h3>
                  ...
                  <form class="forms-sample">
                    ...
                    <div class="form-group">
                      <label for="exampleInputName2">Teacher ID</label>
                    ...
                    <div class="form-group">
                    <label for="exampleSelectPrimary">Select Subject</label>
                    <select class="form-control" id="exampleSelectPrimary">
                      <option>CSE 321</option>
                      <option>CSE 121</option>
                    </select>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Class Time</label>
                      <input type="text" class="form-control" id="exampleInputEmail3" placeholder="8am-10am">
                    </div>
            ...
            <div class="container-fluid clearfix">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © 2020<a href="#">UrbanUI</a>. All rights reserved.</span>
