        ...
        <div class="content-wrapper">
          <div class="row mb-3">
            ...
            <div class="col-md-10 m-auto  grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h3 class="card-title text-center">Appication Form</h3>
                  ...
                  <form class="forms-sample">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail3" placeholder="12...">
                    </div>
                    <div class="form-group">
                    <label for="exampleSelectPrimary">Select Teacher</label>
                    <select class="form-control" id="exampleSelectPrimary">
                      <option>Abdus Sattar</option>
                      <option>Majedur Rahman</option>
                    </select>
                    </div>
                    <div class="form-group">
